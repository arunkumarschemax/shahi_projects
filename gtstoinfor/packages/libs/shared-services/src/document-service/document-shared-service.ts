import { CommonResponseModel, DocumentDto, DocumentIdReq, DocumentResponseModel } from "@project-management-system/shared-models";
...
async updateDownloadStatus(req:DocumentIdReq):Promise<DocumentResponseModel>{
  return this.axiosPostCall(this.url + "/updateDownloadStatus", req)
}
}