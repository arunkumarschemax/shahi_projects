...
export class SampleDevelopmentService extends CommonAxiosService {
  ...
  async getFabricPaths(req: SampleItemIdRequest): Promise<CommonResponseModel> {
    return this.axiosPostCall(this.URL + "/getFabricPaths", req)
  }
  ...
  async updateSamplingperson(req: UserIdRequest): Promise<CommonResponseModel> {
    return this.axiosPostCall(this.URL + "/updateSamplingperson", req)
  }
