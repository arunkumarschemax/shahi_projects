export const config = {
    ...
    // file_upload_path: 'http://165.22.220.143/sanmar/gtstoinfor/dist/packages/services/common/',
    file_upload_path: 'http://165.22.220.143/sanmar/gtstoinfor/upload_files/'
