export const config = {
    ...
    whatsapp_broadcast_url: 'http://206.189.138.212:3232/api',
     ...
     APP_PROJECT_MANAGEMENT_URL: "https://eddie-backend.shahiapps.in/api",
    //  APP_PROJECT_MANAGEMENT_URL: "http://localhost:9007/api",
    ...
    file_upload_path: 'http://165.22.220.143/eddiebauer/gtstoinfor/upload_files/'
