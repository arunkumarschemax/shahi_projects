...
export class M3ItemsService {
  ...
  async getM3Items(): Promise<CommonResponseModel> {
    ...
    m3.yarn_count,m3.finish,m3.shrinkage,ft.fabric_type_name,fw.fabric_weave_name, uom1.uom AS weightUnit,
     uom2.uom AS yarnUnit, b.buyer_name AS buyer, m3.width ,uom3.uom AS widthUnit FROM m3_items m3
    ...
    ORDER BY b.buyer_name,m3.content,m3.fabric_type,m3.weave,m3.weight`
