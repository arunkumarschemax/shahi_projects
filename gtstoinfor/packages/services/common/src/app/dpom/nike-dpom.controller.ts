...
import { CommonResponseModel, FobPriceDiffRequest, ItemNoDto, PpmDateFilterRequest, coLineRequest, nikeFilterRequest } from '@project-management-system/shared-models';
...
export class DpomController {
    ...
    @Post('/updateDivertDataValues')
    async updateDivertDataValues(@Body() req: any): Promise<CommonResponseModel> {
        try {
            return await this.dpomService.updateDivertDataValues(req);
        } catch (err) {
            return this.applicationExceptionhandler.returnException(CommonResponseModel, err);
        }
    }
    ...
    async updateCOLineStatus(@Body() req: any): Promise<CommonResponseModel> {
        try {
            return this.dpomService.updateCOLineStatus(req);
        } catch (err) {
            return this.applicationExceptionhandler.returnException(CommonResponseModel, err);
        }
    }
    ...
    @Post('updateDomItme')
    async updateDomItme(@Body() req: ItemNoDto[]): Promise<CommonResponseModel> {
        try {
