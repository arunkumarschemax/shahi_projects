...
import { AllUsersResponseModel, UsersResponseModel } from '@project-management-system/shared-models'
...
export class UsersController {
    ...
    async getAllUsers(): Promise<AllUsersResponseModel> {
        try {
            ...
            console.log(error);
            return this.applicationExceptionhandler.returnException(AllUsersResponseModel, error)
        }
    }
