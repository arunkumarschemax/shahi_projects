...
newDate = moment(dateObject).format('MM-DD')
        ...
        if (dtoData.orderPlanNumber != null) {
            ...
            if (details) {
                ...
                const convertedExcelEntity: Partial<OrdersChildEntity> = this.ordersChildAdapter.convertDtoToEntity(dtoData,id,details.productionPlanId,Number(month),dtoData.exf != null? dtoData.exf : newDate);
                ...
                if(dtoData.publishFlagForFactory !== 'NotPub'){
                    ...
                    const convertedExcelEntity: Partial<OrdersEntity> = this.ordersAdapter.convertDtoToEntity(dtoData, id, Number(month),dtoData.exf != null? dtoData.exf : newDate);
                    ...
                    const convertedChildExcelEntity: Partial<OrdersChildEntity> = this.ordersChildAdapter.convertDtoToEntity(dtoData,id,saveExcelEntity.productionPlanId,Number(month),dtoData.exf != null? dtoData.exf : newDate);
