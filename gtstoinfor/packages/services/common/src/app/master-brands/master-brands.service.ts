...
export class MasterBrandsService {
  ...
  //         if (brandExists) {
  //             if (brandReq.versionFlag !== brandExists.versionFlag) {
  //                 throw new MasterBrandsResponseModel(false,10113, 'Someone updated the current brand information.Refresh and try again');
  //             } else {
  ...
  //                             console.log(brandResponse,'ppppppp')

  //                             return brandResponse;
  //                         } else {
  //                           console.log(MasterBrandsResponseModel,'...........')
