...
export class GrnAdapter
{
    // public convertDtoToEntity(indentDto:IndentDto, isUpdate: boolean = false ):GrnEntity{
    ...
    //      return indententity;
    // }
    // public convertEntityToDto(indentObject: GrnEntity): IndentDto {
