...
import { SubstituionModel } from "@project-management-system/shared-models";
...
export class SubstitutionRepository extends Repository<Substitution> {
   ...
   async getSubstitution(req:SubstituionModel):Promise<any>{
    ...
    .where('sub.fg_item_code=:fgItemCode',{fgItemCode:req.fgItemCode})
