...
@ViewEntity({
    expression: `
    SELECT i.item_id AS itemId,item_name AS itemName,item_code AS itemCode,hsn_code As hsnCode,i.is_active AS isActive,ic.item_category_id AS itemCategoryId,ic.item_category AS itemCategory,
