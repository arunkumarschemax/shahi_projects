...
export class FabricIndentRepository extends Repository<IndentFabricEntity> {
    ...
    async getFabricIndentData (indentId:number){
        ...
        co.colour,bu.buyer_name,ss.quantity,it.status, uom.uom AS quantityUnit,uom1.uom AS unit, uom2.uom AS weightUnit,uom3.uom AS moqUnit, uom4.uom AS moqPriceUnit `)
