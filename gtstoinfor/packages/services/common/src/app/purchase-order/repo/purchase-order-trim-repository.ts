...
export class PurchaseOrderTrimRepository extends Repository<PurchaseOrderTrimEntity> {
    ...
    async getPOTrimData(req:VendorIdReq):Promise<any>{
        ...
        .select(`mt.trim_code as m3TrimCode,pot.po_trim_id AS poTrimId,pot.trim_id AS trimId, pot.m3_trim_code AS m3TrimCode,pot.purchase_order_id AS poId, pot.po_quantity AS poQuantity,
