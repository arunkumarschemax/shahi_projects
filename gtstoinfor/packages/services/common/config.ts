...
export const appConfig = {
    ...
    database: {
        ...
        host: process.env[`APP_DB_HOST`] || '139.59.23.204',
        port: parseInt(process.env[`APP_DB_PORT`]) || 3306,
        username: process.env[`APP_DB_USER`] || 'test',
        password: process.env[`APP_DB_PASS`] || 'test@123',
        dbName: process.env[`APP_DB_DBNAME`] || 'shahi_levis',
