...
export function LevisOrderReport() {
  ...
  const getorderData = () => {
    ...
    service.getOrderReportData(req).then((res) => {
    ...
    columns.push(
...

      {
        ...
        render: (text, record) => {
          ...
          const totalValue = (sum * parseFloat(record.unitPrice)).toFixed(2);
          return `${totalValue}`;
        },
      },
      ...
      {
        title: "FTY Discussion",
        dataIndex: "ftyDiscussion",
        width: 90,
        //    sorter: (a, b) => a.poNumber.localeCompare(b.poNumber),
        //    sortDirections: ["ascend", "descend"],
        render: (text) => text ? text : "-",
      ...
      {
        title: "Original X Fty",
        dataIndex: "originalFty",
        width: 90,
        //    sorter: (a, b) => a.poNumber.localeCompare(b.poNumber),
        //    sortDirections: ["ascend", "descend"],
        render: (text) => text ? text : "-",
      ...
      {
        title: "Factory Delivery Date",
        dataIndex: "factoryDeliveryDate",
        width: 90,
        //    sorter: (a, b) => a.poNumber.localeCompare(b.poNumber),
        //    sortDirections: ["ascend", "descend"],
        render: (text) => text ? text : "-",
      ...
      {
        title: "Improvement/Deferment",
        dataIndex: "improvementDeferment",
        width: 90,
        //    sorter: (a, b) => a.poNumber.localeCompare(b.poNumber),
        //    sortDirections: ["ascend", "descend"],
        render: (text) => text ? text : "-",
      ...
      {
        title: "CARTS Closed Date",
        dataIndex: "cartsClosedDate",
        width: 90,
        //    sorter: (a, b) => a.poNumber.localeCompare(b.poNumber),
        //    sortDirections: ["ascend", "descend"],
        render: (text) => text ? text : "-",
      ...
      {
        title: "Shipped Qty Value",
        dataIndex: "shippedQtyValue",
        width: 90,
        //    sorter: (a, b) => a.poNumber.localeCompare(b.poNumber),
        //    sortDirections: ["ascend", "descend"],
        render: (text) => text ? text : "-",
  ...
  return (
    <>
      <Card title="Order Report " headStyle={{ fontWeight: "bold" }}
        extra={
          <Button
            type="default"
            style={{ color: "green" }}
...
export default LevisOrderReport;
