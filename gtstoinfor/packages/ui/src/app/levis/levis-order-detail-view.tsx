...
//   }, []);
    ...
    return (
        ...
        extra ={<Link to='/levis/levis-order-data-info-grid' ><Button className='panel_button' type="primary" >View </Button></Link>}
        >
...
export default LevisOrdersDetailView;