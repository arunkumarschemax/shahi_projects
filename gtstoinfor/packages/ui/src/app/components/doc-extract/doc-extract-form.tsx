...
import { Steps, Divider, Select, Spin, message, Button, Input, Card } from "antd";
        ...
        <div>
            ...
            <div style={{ display: "flex", justifyContent: "center" }}>
                <div style={{ width: "50%", marginRight: "20px" }}>
                    {current === 1 && image && (
                        <div style={{ maxHeight: "70vh", overflowX: "scroll", overflowY: "scroll" }}>
                            <img
                                ...
                                <>
                                    <div>
                                        <Button
                                            ...
                                            style={{ marginRight: '10px', position: "relative", right: "300px", top: "130px" }}
