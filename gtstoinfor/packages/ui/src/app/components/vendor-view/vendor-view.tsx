...
import {Card,Table,Input,Button,Space,message,Select,Form,Col,Row} from "antd";
      ...
      <Space direction="vertical" style={{ width: "100%" }}>
        <Form  form={form} onFinish={handleSearch}>
          <Row gutter={24}>
            ...
            <Button htmlType="submit" style={{  color: "white", background: "forestgreen" }} icon={<SearchOutlined />}>
              Search
            </Button>

            <Button style={{  margin: '0 14px' }} danger icon={<UndoOutlined />} onClick={handleReset}>
              Reset
            </Button>
            </Col>
