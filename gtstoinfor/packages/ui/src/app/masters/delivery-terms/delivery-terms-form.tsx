...
export function DeliveryTermsForm(
  ...
  return (
    ...
    <Card title={props.isUpdate ? 'Update Delivery Terms' : 'Add Delivery Term'} extra={props.isUpdate === true?"": <span><Button onClick={() => navigate('/global/delivery-terms/delivery-terms-view')} type={'primary'}>View</Button></span>}>
