...
export function LocationsForm(
  ...
  return (
    ...
    <Card title={props.isUpdate ? 'Update Locations' : 'Add location'} extra={(props.isUpdate === false) && <span><Button onClick={() => navigate('/global/delivery-terms/delivery-terms-view')} type={'primary'}>View</Button></span>}>
