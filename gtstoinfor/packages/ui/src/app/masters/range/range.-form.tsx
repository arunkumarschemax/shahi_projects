...
export function  RangeForm (props: FormProps) {
  ...
  return (
    <Card title={<span >Range</span>} style={{textAlign:'left'}} headStyle={{ border: 0 }} extra={props.isUpdate==true?"":<Link to='/masters/range/range-grid' ><span style={{color:'white'}} ><Button type={'primary'} >View </Button> </span></Link>} >
