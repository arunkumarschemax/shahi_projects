...
export const AddressView = () => {
    ...
    const exceldata = [
        ...
        { title: 'Country', dataIndex: 'country',render:(text:any,record:any) => {return record.country ? record.country : '-'} },
        { title: 'Delivary address', dataIndex: 'deliveryAddress',render:(text:any,record:any) => {return record.deliveryAddress ? record.deliveryAddress : '-'} },
        { title: 'Buyeradderss', dataIndex: 'buyerAddress',render:(text:any,record:any) => {return record.buyerAddress ? record.buyerAddress : '-'} },
