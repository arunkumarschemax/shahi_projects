...
export const ColorView = () => {
    ...
    const columns : any[] = [
        ...
        },
        {
            ...
            title:<div style={{textAlign:"center"}}>Color Code</div>,
           width:50,
            dataIndex:'colorCode',
            align:"center",
        ...
        {
          title:<div style={{textAlign:"center"}}>Color Name</div>,
            dataIndex:'colorName',
            align:"center",
            width:50,
    ...
    const exceldata = [
        ...
        { title: 'Color Code', dataIndex: 'colorCode',width:120,render:(text:any,record:any) => {return record.colorCode ? record.colorCode : '-'} },
        { title: 'Color Name', dataIndex: 'colorName',width:120,render:(text:any,record:any) => {return record.colorName ? record.colorName : '-'} },
    ...
    return(
        <Card title='Color' extra={<Link to='/levis/masters/color/color-excel-upload' >
