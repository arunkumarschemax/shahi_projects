...
export function OperationsForm(
  ...
  return (
    <Card title={props.isUpdate ? 'Update Operation' : 'Add Operation'} extra={(props.isUpdate === false) && <span><Button onClick={() => navigate('/masters/operations/operation-view')} type={'primary'}>View</Button></span>} headStyle={{ backgroundColor: '#69c0ff', border: 0 }}>
