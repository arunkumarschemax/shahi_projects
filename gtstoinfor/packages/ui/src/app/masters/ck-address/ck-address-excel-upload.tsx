      ...
      const handleUpload = async() => {
        try{
            form.validateFields().then(async () => {
                const res = await service.ckSaveAddressInfo(data).then(res => {
                    setLoading(true);
                    if(res.status){
                        AlertMessages.getSuccessMessage(res.internalMessage)
                        navigate("/pvh/masters/ck-address/ck-address-view")
...
export default CkAddressUpload