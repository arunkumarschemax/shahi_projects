...
const FabricContentForm = (props:Formprops) => {
  ...
  return (
    ...
    </CSVLink></Button> <Button onClick={() => navigate('/masters/fabric-content-view')} type={'primary'}>View</Button></span>}>
      <Form form={form}
...

          {
            state?.name === 'new' || state == null ? (<>
              ...
              <Col xs={{ span: 24 }} sm={{ span: 24 }} md={{ span: 8 }} lg={{ span: 6 }} xl={{ span: 6 }}>
                ...
                <Col xs={{ span: 24 }} sm={{ span: 24 }} md={{ span: 8 }} lg={{ span: 6 }} xl={{ span: 6 }}>
                  <Form.Item name='planningSeasonCode' label='Component'
                    rules={[
                ...
                <Col xs={{ span: 24 }} sm={{ span: 24 }} md={{ span: 8 }} lg={{ span: 6 }} xl={{ span: 6 }}>
                  <Form.Item name='shahiConfirmedGrossPriceCurrencyCode' label='Fabric Content'
                    rules={[{ required: true, message: 'Please enter the Fabric Content' },
                    ]}
                  >
                    <Input placeholder='Shahi Confirmed Gross Fabric Content' />
                  </Form.Item>
                </Col>
              </Row>
            </>) : (<></>)
