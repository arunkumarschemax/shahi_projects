...
//   }
  ...
  return (
    <Card title={props.isUpdate ? 'Update Vendor' : 'Add Vendor'} extra={(props.isUpdate === false) && <span><Button onClick={() => navigate('/global/vendors/vendors-view')} type={'primary'}>View</Button></span>}>
