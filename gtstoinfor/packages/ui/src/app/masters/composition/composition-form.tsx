...
export function  CompositionForm (props: FormProps) {
  ...
  return (
    <Card title={<span >Composition</span>} style={{textAlign:'left'}} headStyle={{ border: 0 }} extra={props.isUpdate==true?"":<Link to='/masters/composition/composition-grid' ><span style={{color:'white'}} ><Button type={'primary'} >View </Button> </span></Link>} >
