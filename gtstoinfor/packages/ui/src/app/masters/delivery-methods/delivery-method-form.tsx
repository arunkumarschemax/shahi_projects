...
export function DeliveryMethodForm(props: DeliveryMethodFormProps) {
  ...
  return (
    <Card title={<span >Delivery Method</span>} style={{textAlign:'center'}} headStyle={{ backgroundColor: '#69c0ff', border: 0 }} extra={props.isUpdate==true?"":<Link to='/global/delivery-methods/delivery-method-view' ><span style={{color:'white'}} ><Button type={'primary'} >View </Button> </span></Link>} >
