...
export const extractDataFromPoPdf = async (pdf) => {
    ...
    for (let i = 1; i <= pdf.numPages; i++) {
        ...
        if (i == 1) {
            ...
            for (let i = dateSentIndex + 28; i < firstPageContent.length; i++) {
