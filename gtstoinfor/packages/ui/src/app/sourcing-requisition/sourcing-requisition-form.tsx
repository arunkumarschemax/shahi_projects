...
export const SourcingRequisitionForm = () => {
    ...
    return(
        <Card title='Sourcing Requisition' headStyle={{ backgroundColor: '#69c0ff', border: 0 }} style={{textAlign:'center'}}  extra={<span><Button onClick={() => navigate('/sourcing-requisition-view')} type={'primary'}>View</Button></span>}>
