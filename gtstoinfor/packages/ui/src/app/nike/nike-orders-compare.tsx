...
const  OrdersCompareGrid = () => {
    ...
    const items: TabsProps['items'] = [
        ...
        },
        {
            ...
            children: <Table bordered dataSource={poStatusData} columns={columns2} scroll={{ x: 'max-content' }} />,
        },
        {
            key: '5',
        ...
        },
        {
            ...
            children: <Table bordered dataSource={productCodeChaneData} columns={columns6} scroll={{ x: 'max-content' }} />,
        },
        {
            key: '7',
        ...
        },
        {
            ...
            children: <Table bordered dataSource={itemTextChaneData} columns={columns5} scroll={{ x: 'max-content' }}/>,
        }
    ];
