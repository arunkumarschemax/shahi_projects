                ...
                if (res.status) {
                    ...
                    res.data.forEach(item => {
                        csvdata.push({
                            ...
                            'Last Modified Date': item.lastModifiedDate ? moment(item.lastModifiedDate).format('MM/DD/YYYY') : '-',
                            'Item': item.item ? (item.item).substring(0, 4) : '-',
                            'Factory': item.factory,
                            'Document Date': item.documentDate ? moment(item.documentDate).format('MM/DD/YYYY') : '-',
                            ...
                            'MRGAC': item.MRGAC ? moment(item.MRGAC).format('MM/DD/YYYY') : '-',
                            'OGAC': item.OGAC ? moment(item.OGAC).format('MM/DD/YYYY') : '-',
                            'GAC': item.GAC ? moment(item.GAC).format('MM/DD/YYYY') : '-',
