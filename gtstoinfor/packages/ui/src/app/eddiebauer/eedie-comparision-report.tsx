...
import { CentricService, EddieService, OrdersService, RLOrdersService } from "@project-management-system/shared-services"
...
export const EddieComparisionReport = () => {
...
export default EddieComparisionReport