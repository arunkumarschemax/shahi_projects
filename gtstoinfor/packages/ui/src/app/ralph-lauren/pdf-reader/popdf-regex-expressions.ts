...
export const ITEM_NO_EXP = 'Material Number'
export const ITEM_NO_INDEX = 0
export const ITEM_MATERIAL_INDEX = 'Material Number'
...
export const ITEM_TEXT_END_TEXT = 'PO Line Total'
export const ITEM_TEXT_END_TEXT2 = 'Purchase Order Total'
export const UNWANTED_TEXT_1 = 'Order Remarks / Comments'
