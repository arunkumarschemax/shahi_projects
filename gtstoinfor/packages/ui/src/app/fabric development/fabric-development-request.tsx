...
//   const onFinish = (values:any) => {
//     console.log(parentFilesMap,"parent");
//     const data =[]
//     Object.values(qualitieData).forEach(val => { data.push(val)});
...
//     const files = [];
//     const formData = new FormData();
//     formData.append('formContent', JSON.stringify(req));

   

//     parentFilesMap.forEach((uploadedFiles, parentKey) => {
//       console.log(uploadedFiles,"ffffffff")
...
//     service.createFabricDevelopmentRequest(formData,config).then((res)=>{
//       console.log(res,"res.........")
//       setDisable(false)
...
//               <Upload   
//               action={ (file) => uploadFile(file, 'Parent') }
//               accept='.jpeg,.png,.jpg' 
//               multiple
...
//           </Row>
//           <div>
//             <FabricDevelopmentTabs key="1"  qualities={qualities} fileList={fileList}  onUpload={uploadFile}/>
//           </div>
//           {/* <Card>
//           <div>
    ...
    >
      ...
      >
        <Card>
          ...
          <div>
            <FabricDevelopmentTabs key="1"  qualities={qualities} fileList={fileList} />
          </div>
          {/* <Card>
          <div>
            <FabricDevelopmentRequestQuality itemsInfo = {itemsInfo} />
