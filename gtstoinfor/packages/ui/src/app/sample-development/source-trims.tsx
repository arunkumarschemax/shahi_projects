...
export interface SourceTrimsProps {
  MaterialIssueID: number;
}

export const SourceTrims = (props: SourceTrimsProps) => {
  ...
  const getAllTrims = (id) => {
    const req = new MaterialIssueIdreq(id);
    service.getAllTrimDetails(req).then((res) => {
      if (res) {
        console.log(res, "trimssssssssssssssssssssssssssssss");
