      ...
      <Card 
        ...
        >
            ...
            <Collapse expandIcon={({ isActive }) => <CaretRightOutlined rotate={isActive ? 90 : 0} />} accordion>
                ...
                <Collapse.Panel header={<HeaderRow consumptionCode={item.consumptionCode} requestNo={item.requestNo} date={item.date} buyer={item.buyer} style={item.style} sampleIndentDate={item.sampleIndentDate} poNumber={item.poNumber} />} key={index}>
                    <Space direction="vertical" style={{fontSize:"16px",width:'100%'}}>
                        <SourceIssuesDetailView/>
                    </Space>
                </Collapse.Panel>
                ))}
            </Collapse>
