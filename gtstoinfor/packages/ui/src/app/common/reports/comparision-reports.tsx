  ...
  // excel.saveAs('revisedPOs.xlsx');
    ...
    for (const res of year) {
      ...
      const totalsPcsRow = {
        planning_sum: "Total",
        prod_plan_type: "",
        janExfPre: Number(totalJanExfPre),
        janExfLat: Number(totalJanExfLat),
        febExfPre: Number(totalFebExfPre),
        febExfLat: Number(totalFebExfLat),
        marExfPre: Number(totalMarExfPre),
        marExfLat: Number(totalMarExfLat),
        aprExfPre: Number(totalAprExfPre),
        aprExfLat: Number(totalAprExfLat),
        mayExfPre: Number(totalMayExfPre),
        mayExfLat: Number(totalMayExfLat),
        junExfPre: Number(totalJunExfPre),
        junExfLat: Number(totalJunExfLat),
        julExfPre: Number(totalJulExfPre),
        julExfLat: Number(totalJulExfLat),
        augExfPre: Number(totalAugExfPre),
        augExfLat: Number(totalAugExfLat),
        sepExfPre: Number(totalSepExfPre),
        sepExfLat: Number(totalSepExfLat),
        octExfPre: Number(totalOctExfPre),
        octExfLat: Number(totalOctExfLat),
        novExfPre: Number(totalNovExfPre),
        novExfLat: Number(totalNovExfLat),
        decExfPre: Number(totalDecExfPre),
        decExfLat: Number(totalDecExfLat),
        totalExfPre: Number(totalPreExf),
        totalExfLat: Number(totalLatExf),
      }
      const totalsCoeffRow = {
        planning_sum: "Total",
        prod_plan_type: "",
        janWhPre: Number(totalJanWhPre),
        janWhLat: Number(totalJanWhLat),
        febWhPre: Number(totalFebWhPre),
        febWhLat: Number(totalFebWhLat),
        marWhPre: Number(totalMarWhPre),
        marWhLat: Number(totalMarWhLat),
        aprWhPre: Number(totalAprWhPre),
        aprWhLat: Number(totalAprWhLat),
        mayWhPre: Number(totalMayWhPre),
        mayWhLat: Number(totalMayWhLat),
        junWhPre: Number(totalJunWhPre),
        junWhLat: Number(totalJunWhLat),
        julWhPre: Number(totalJulWhPre),
        julWhLat: Number(totalJulWhLat),
        augWhPre: Number(totalAugWhPre),
        augWhLat: Number(totalAugWhLat),
        sepWhPre: Number(totalSepWhPre),
        sepWhLat: Number(totalSepWhLat),
        octWhPre: Number(totalOctWhPre),
        octWhLat: Number(totalOctWhLat),
        novWhPre: Number(totalNovWhPre),
        novWhLat: Number(totalNovWhLat),
        decWhPre: Number(totalDecWhPre),
        decWhLat: Number(totalDecWhLat),
        totalWhpre: Number(totalPreWh),
        totalWhLat: Number(totalLatWh),
      }
      if (selected == 'ExFactory') {
