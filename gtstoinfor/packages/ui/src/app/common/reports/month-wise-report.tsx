...
export const MonthWiseReport = () => {
  ...
  const handleExport = async (e: any) => {
    ...
    const totalsPcsRow = {
      planning_sum: "Total",
      prod_plan_type: "",
      janPcsExf: Number(totalJanExfPre),
      janCoeffExf: Number(totalJanExfLat),
      febPcsExf: Number(totalFebExfPre),
      febCoeffExf: Number(totalFebExfLat),
      marPcsExf: Number(totalMarExfPre),
      marCoeffExf: Number(totalMarExfLat),
      aprPcsExf: Number(totalAprExfPre),
      aprCoeffExf: Number(totalAprExfLat),
      mayPcsExf: Number(totalMayExfPre),
      mayCoeffExf: Number(totalMayExfLat),
      junPcsExf: Number(totalJunExfPre),
      junCoeffExf: Number(totalJunExfLat),
      julPcsExf: Number(totalJulExfPre),
      julCoeffExf: Number(totalJulExfLat),
      augPcsExf: Number(totalAugExfPre),
      augCoeffExf: Number(totalAugExfLat),
      sepPcsExf: Number(totalSepExfPre),
      sepCoeffExf: Number(totalSepExfLat),
      octPcsExf:Number (totalOctExfPre),
      octCoeffExf:Number (totalOctExfLat),
      novPcsExf: Number(totalNovExfPre),
      novCoeffExf: Number(totalNovExfLat),
      decPcsExf:Number (totalDecExfPre),
      decCoeffExf:Number (totalDecExfLat),
      ExfPcsTotal: Number(totalPreExf),
      ExfCoeffTotal: Number(totalLatExf),
    }
    const totalsCoeffRow = {
      planning_sum: "Total",
      prod_plan_type: "",
      janPcsWh: Number(totalJanWhPre),
      janCoeffWh: Number(totalJanWhLat),
      febPcsWh: Number(totalFebWhPre),
      febCoeffWh: Number(totalFebWhLat),
      marPcsWh: Number(totalMarWhPre),
      marCoeffWh: Number(totalMarWhLat),
      aprPcsWh: Number(totalAprWhPre),
      aprCoeffWh: Number(totalAprWhLat),
      mayPcsWh: Number(totalMayWhPre),
      mayCoeffWh: Number(totalMayWhLat),
      junPcsWh: Number(totalJunWhPre),
      junCoeffWh: Number(totalJunWhLat),
      julPcsWh: Number(totalJulWhPre),
      julCoeffWh: Number(totalJulWhLat),
      augPcsWh: Number(totalAugWhPre),
      augCoeffWh: Number(totalAugWhLat),
      sepPcsWh: Number(totalSepWhPre),
      sepCoeffWh: Number(totalSepWhLat),
      octPcsWh: Number(totalOctWhPre),
      octCoeffWh: Number(totalOctWhLat),
      novPcsWh: Number(totalNovWhPre),
      novCoeffWh: Number(totalNovWhLat),
      decPcsWh: Number(totalDecWhPre),
      decCoeffWh: Number(totalDecWhLat),
      WhPcsTotal: Number(totalPreWh),
      WhCoeffTotal: Number(totalLatWh),
    }
    if (selected == 'ExFactory') {
